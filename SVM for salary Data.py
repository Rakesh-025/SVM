...
salary_train = pd.read_csv("C:\\Users\\ADMIN\\OneDrive\\Desktop\\svm\\SalaryData_Train (1).csv")
salary_test = pd.read_csv("C:\\Users\\ADMIN\\OneDrive\\Desktop\\svm\\SalaryData_Test (1).csv")
